...
const SpotifyHomePage = () => {
  ...
  return (
    <div className="text-center mt-40">
      <h2 className="text-[1rem] font-inherit mt-8 text-white outfit-font mq750:gap-[5.88rem] mq1025:gap-[5.88rem] mb-7">latest  on  <img src={spotify2} alt="Spotify Icon" className="inline-block h-[1.13rem] w-[1.13rem]" /></h2>
